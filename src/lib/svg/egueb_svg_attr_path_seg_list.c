 ...
 *                                  Local                                     *
 *============================================================================*/
#define EGUEB_SVG_ATTR_PATH_SEG_LIST_DESCRIPTOR 				\
		egueb_svg_attr_path_seg_list_descriptor_get()
#define EGUEB_SVG_ATTR_PATH_SEG_LIST(o) ENESIM_OBJECT_INSTANCE_CHECK(o,	\
		Egueb_Svg_Attr_Path_Seg_List, 				\
		EGUEB_SVG_ATTR_PATH_SEG_LIST_DESCRIPTOR)
...
static Eina_Bool _egueb_svg_attr_path_seg_list_value_get(Egueb_Dom_Attr *p,
		Egueb_Dom_Attr_Type type, void ***o)
{
	Egueb_Svg_Attr_Path_Seg_List *thiz;

	thiz = EGUEB_SVG_ATTR_PATH_SEG_LIST(p);
	switch (type)
	{
...
static void _egueb_svg_attr_path_seg_list_class_init(void *k)
{
	Egueb_Dom_Attr_Class *p_klass;
	Egueb_Dom_Attr_Object_Class *o_klass;

	p_klass = EGUEB_DOM_ATTR_CLASS(k);
	p_klass->value_descriptor_get = _egueb_svg_attr_path_seg_list_value_descriptor_get;

	o_klass = EGUEB_DOM_ATTR_OBJECT_CLASS(k);
	o_klass->value_get = _egueb_svg_attr_path_seg_list_value_get;
}

static void _egueb_svg_attr_path_seg_list_instance_init(void *o)
{
}

static void _egueb_svg_attr_path_seg_list_instance_deinit(void *o)
{
}
/*============================================================================*
 *                                 Global                                     *
		...
		Eina_Bool inheritable)
{
	...
	n = ENESIM_OBJECT_INSTANCE_NEW(egueb_svg_attr_path_seg_list);
