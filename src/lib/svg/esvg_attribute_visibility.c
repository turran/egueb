 ...
 *                                  Local                                     *
 *============================================================================*/
static Eina_Bool _egueb_svg_attribute_visibility_value_get(const char *attr, void **value)
{
	Egueb_Svg_Visibility *v = *value;

	egueb_svg_visibility_string_from(v, attr);
	return EINA_TRUE;
}

/* The different animated desriptors */
Egueb_Svg_Attribute_Animated_Descriptor egueb_svg_attribute_animated_visibility_descriptor = {
	/* .value_new 			= */ egueb_svg_attribute_enum_value_new,
	/* .value_get 			= */ _egueb_svg_attribute_visibility_value_get,
	/* .value_free 			= */ free,
