...
const extern Egueb_Svg_Length EGUEB_SVG_LENGTH_0;
const extern Egueb_Svg_Length EGUEB_SVG_LENGTH_1;
const extern Egueb_Svg_Length EGUEB_SVG_LENGTH_100_PERCENT;
const extern Egueb_Svg_Length EGUEB_SVG_LENGTH_50_PERCENT;
