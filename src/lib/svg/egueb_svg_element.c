...
static void _egueb_svg_element_instance_init(void *o)
{
	...
	egueb_dom_event_target_event_listener_add(evt, EGUEB_DOM_EVENT_FOCUS_IN,
			_egueb_svg_element_onfocusout_cb, EINA_FALSE, thiz);
	egueb_dom_event_target_event_listener_add(evt, EGUEB_DOM_EVENT_FOCUS_OUT,
			_egueb_svg_element_onfocusin_cb, EINA_FALSE, thiz);
#if 0
	egueb_dom_event_target_event_listener_add(evt, "activate", _egueb_svg_element_onactivate_cb, thiz);
#endif
	egueb_dom_event_target_event_listener_add(evt, EGUEB_DOM_EVENT_MOUSE_CLICK,
			_egueb_svg_element_onclick_cb, EINA_FALSE, thiz);
	egueb_dom_event_target_event_listener_add(evt, EGUEB_DOM_EVENT_MOUSE_DOWN,
			_egueb_svg_element_onmousedown_cb, EINA_FALSE, thiz);
	egueb_dom_event_target_event_listener_add(evt, EGUEB_DOM_EVENT_MOUSE_UP,
	...
	egueb_dom_event_target_event_listener_add(evt, EGUEB_DOM_EVENT_MOUSE_MOVE,
