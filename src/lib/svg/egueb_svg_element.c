 ...
 *                           The Ender interface                              *
 *----------------------------------------------------------------------------*/
static Egueb_Svg_Type _egueb_svg_element_type_get(Egueb_Dom_Tag *t)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_id_get(Egueb_Dom_Tag *t, const char **id)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_id_set(Egueb_Dom_Tag *t, const char *id)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_class_set(Egueb_Dom_Tag *t, const char *class)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_class_get(Egueb_Dom_Tag *t, const char **class)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_transform_set(Egueb_Dom_Tag *t, const Egueb_Svg_Matrix_Animated *transform)
{
	Egueb_Svg_Element *thiz;
	Enesim_Matrix m;
	...
	egueb_svg_attribute_animated_transform_extended_set(&thiz->transform,
		transform, &m, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_transform_get(Egueb_Dom_Tag *t, Egueb_Svg_Matrix_Animated *transform)
{
	Egueb_Svg_Element *thiz;
...
static Eina_Bool _egueb_svg_element_transform_is_set(Egueb_Dom_Tag *t)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_style_set(Egueb_Dom_Tag *t, const char *style)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_style_get(Egueb_Dom_Tag *t, const char **style)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_clip_path_set(Egueb_Dom_Tag *t, Egueb_Svg_Animated_Clip_Path *clip_path)
{
	Egueb_Svg_Element *thiz;
	Egueb_Svg_Clip_Path def = { ESVG_CLIP_PATH_NONE };

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_clip_path_extended_set(&thiz->current_attr->clip_path,
		clip_path, &def, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_clip_path_get(Egueb_Dom_Tag *t, Egueb_Svg_Animated_Clip_Path *clip_path)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_clip_path_get(&thiz->current_attr->clip_path,
		clip_path);
}

static void _egueb_svg_element_clip_path_unset(Egueb_Dom_Tag *t)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_opacity_set(Egueb_Dom_Tag *t, Egueb_Svg_Number_Animated *opacity)
{
	Egueb_Svg_Element *thiz;
	Egueb_Svg_Number def = { 1.0 };

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_number_extended_set(&thiz->current_attr->opacity,
		opacity, &def, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_opacity_get(Egueb_Dom_Tag *t, Egueb_Svg_Number_Animated *opacity)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_number_get(&thiz->current_attr->opacity,
		opacity);
}

static void _egueb_svg_element_opacity_unset(Egueb_Dom_Tag *t)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_color_set(Egueb_Dom_Tag *t, const Egueb_Svg_Color_Animated *color)
{
	Egueb_Svg_Element *thiz;
	const Egueb_Svg_Color def = { 0, 0, 0};

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_color_set(&thiz->current_attr->color,
		color, &def, thiz->current_attr_animate);
}

static void _egueb_svg_element_color_unset(Egueb_Dom_Tag *t)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_color_get(Egueb_Dom_Tag *t, Egueb_Svg_Color_Animated *color)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_color_get(&thiz->current_attr->color,
		color);
}

static void _egueb_svg_element_fill_set(Egueb_Dom_Tag *t, const Egueb_Svg_Paint_Animated *fill)
{
	Egueb_Svg_Element *thiz;
	Egueb_Svg_Color black = { 0, 0, 0 };
	Egueb_Svg_Paint def = { ESVG_PAINT_TYPE_COLOR, black };

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_paint_extended_set(&thiz->current_attr->fill,
		fill, &def, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_fill_get(Egueb_Dom_Tag *t, Egueb_Svg_Paint_Animated *fill)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_paint_get(&thiz->current_attr->fill,
		fill);
}

static void _egueb_svg_element_fill_unset(Egueb_Dom_Tag *t)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_fill_opacity_set(Egueb_Dom_Tag *t, Egueb_Svg_Number_Animated *fill_opacity)
{
	Egueb_Svg_Element *thiz;
	Egueb_Svg_Number def = { 1.0 };

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_number_extended_set(&thiz->current_attr->fill_opacity,
		fill_opacity, &def, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_fill_opacity_get(Egueb_Dom_Tag *t, Egueb_Svg_Number_Animated *fill_opacity)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_number_get(&thiz->current_attr->fill_opacity,
		fill_opacity);
}

static void _egueb_svg_element_fill_opacity_unset(Egueb_Dom_Tag *t)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_fill_rule_set(Egueb_Dom_Tag *t, Egueb_Svg_Animated_Enum *fill_rule)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_stroke_set(Egueb_Dom_Tag *t, const Egueb_Svg_Paint_Animated *stroke)
{
	Egueb_Svg_Element *thiz;
	Egueb_Svg_Paint def = { ESVG_PAINT_TYPE_NONE };

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_paint_extended_set(&thiz->current_attr->stroke,
		stroke, &def, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_stroke_get(Egueb_Dom_Tag *t, Egueb_Svg_Paint_Animated *stroke)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_paint_get(&thiz->current_attr->stroke,
		stroke);
}

static void _egueb_svg_element_stroke_width_set(Egueb_Dom_Tag *t, const Egueb_Svg_Length_Animated *stroke_width)
{
	Egueb_Svg_Element *thiz;
	Egueb_Svg_Length def = { ESVG_UNIT_LENGTH_PX, 1 };
	Eina_Bool is_set;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_length_extended_set(&thiz->current_attr->stroke_width,
		stroke_width, &def, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_stroke_width_get(Egueb_Dom_Tag *t, Egueb_Svg_Length_Animated *stroke_width)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_length_get(&thiz->current_attr->stroke_width,
		stroke_width);
}

static void _egueb_svg_element_stroke_opacity_set(Egueb_Dom_Tag *t, Egueb_Svg_Number_Animated *stroke_opacity)
{
	Egueb_Svg_Element *thiz;
	Egueb_Svg_Number def = { 1.0 };

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_number_extended_set(&thiz->current_attr->stroke_opacity,
		stroke_opacity, &def, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_stroke_opacity_get(Egueb_Dom_Tag *t, Egueb_Svg_Number_Animated *stroke_opacity)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_number_get(&thiz->current_attr->stroke_opacity,
		stroke_opacity);
}

static void _egueb_svg_element_stroke_line_cap_set(Egueb_Dom_Tag *t, Egueb_Svg_Animated_Enum *cap)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_stroke_line_join_set(Egueb_Dom_Tag *t, Egueb_Svg_Animated_Enum *join)
{
	Egueb_Svg_Element *thiz;
...
static void _egueb_svg_element_stop_color_set(Egueb_Dom_Tag *t, Egueb_Svg_Color_Animated *stop_color)
{
	Egueb_Svg_Element *thiz;
	const Egueb_Svg_Color def = { 0, 0, 0};

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_color_set(&thiz->current_attr->stop_color,
		stop_color, &def, thiz->current_attr_animate);
}

static void _egueb_svg_element_stop_color_get(Egueb_Dom_Tag *t, Egueb_Svg_Color_Animated *stop_color)
{
	Egueb_Svg_Element *thiz;

	if (!stop_color) return;
	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_color_get(&thiz->current_attr->stop_color,
		stop_color);
}

static void _egueb_svg_element_stop_opacity_set(Egueb_Dom_Tag *t, Egueb_Svg_Number_Animated *stop_opacity)
{
	Egueb_Svg_Element *thiz;
	Egueb_Svg_Number def = { 1.0 };

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_number_extended_set(&thiz->current_attr->stop_opacity,
		stop_opacity, &def, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_stop_opacity_get(Egueb_Dom_Tag *t, Egueb_Svg_Number_Animated *stop_opacity)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_number_get(&thiz->current_attr->stop_opacity,
		stop_opacity);
}

static void _egueb_svg_element_visibility_set(Egueb_Dom_Tag *t, Egueb_Svg_Animated_Enum *visibility)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_enum_extended_set(&thiz->current_attr->visibility,
		visibility, ESVG_VISIBILITY_VISIBLE, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_visibility_get(Egueb_Dom_Tag *t, Egueb_Svg_Animated_Enum *visibility)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_enum_get(&thiz->current_attr->visibility,
		visibility);
}

static void _egueb_svg_element_display_set(Egueb_Dom_Tag *t, Egueb_Svg_Animated_Enum *display)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_enum_extended_set(&thiz->current_attr->display,
		display, ESVG_DISPLAY_BLOCK, thiz->current_attr_animate, &thiz->current_attr->sets);
}

static void _egueb_svg_element_display_get(Egueb_Dom_Tag *t, Egueb_Svg_Animated_Enum *display)
{
	Egueb_Svg_Element *thiz;

	thiz = EGUEB_SVG_ELEMENT(t);
	egueb_svg_attribute_animated_enum_get(&thiz->current_attr->display,
		display);
}
...
void egueb_svg_element_property_clip_path_set(Ender_Element *e, Ender_Property *p, const Egueb_Svg_Clip_Path *v)
{
	...
	{
		Egueb_Svg_Animated_Clip_Path a;
