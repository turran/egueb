...
#define EGUEB_SVG_ATTR_VISIBILITY_DESCRIPTOR 					\
		egueb_dom_attr_display_descriptor_get()
#define EGUEB_SVG_ATTR_VISIBILITY(o) ENESIM_OBJECT_INSTANCE_CHECK(o,		\
		Egueb_Svg_Attr_Display, EGUEB_SVG_ATTR_VISIBILITY_DESCRIPTOR)

typedef struct _Egueb_Svg_Attr_Display
{
	Egueb_Dom_Attr_Basic base;
	Egueb_Svg_Display styled;
	Egueb_Svg_Display anim;
	Egueb_Svg_Display value;
	Egueb_Svg_Display def;
} Egueb_Svg_Attr_Display;

typedef struct _Egueb_Svg_Attr_Display_Class
{
	Egueb_Dom_Attr_Basic_Class base;
} Egueb_Svg_Attr_Display_Class;

static Eina_Bool _egueb_svg_attr_display_value_get(Egueb_Dom_Attr *p,
		Egueb_Dom_Attr_Type type, void **o)
{
	Egueb_Svg_Attr_Display *thiz;
...
_egueb_svg_attr_display_value_descriptor_get(Egueb_Dom_Attr *p)
{
	return egueb_svg_display_descriptor_get();
}
/*----------------------------------------------------------------------------*
 *                              Object interface                              *
 *----------------------------------------------------------------------------*/
ENESIM_OBJECT_INSTANCE_BOILERPLATE(EGUEB_DOM_ATTR_BASIC_DESCRIPTOR,
		Egueb_Svg_Attr_Display, Egueb_Svg_Attr_Display_Class,
		egueb_svg_attr_display)

static void _egueb_svg_attr_display_class_init(void *k)
{
	Egueb_Dom_Attr_Class *p_klass;
	Egueb_Dom_Attr_Basic_Class *o_klass;

	p_klass = EGUEB_DOM_ATTR_CLASS(k);
	p_klass->value_descriptor_get = _egueb_svg_attr_display_value_descriptor_get;

	o_klass = EGUEB_DOM_ATTR_BASIC_CLASS(k);
	o_klass->value_get = _egueb_svg_attr_display_value_get;
}

static void _egueb_svg_attr_display_instance_init(void *o)
{
}

static void _egueb_svg_attr_display_instance_deinit(void *o)
{
}
/*============================================================================*
 *                                 Global                                     *
