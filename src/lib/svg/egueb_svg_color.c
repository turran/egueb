...
/* Css color table */
static Egueb_Svg_Color_Entry colors[] = {
...
static Eina_Bool _egueb_svg_color_name_to_value(const char *name, Enesim_Argb *argb)
{
	int i;
...
static Eina_Bool _egueb_svg_color_value_to_name(Enesim_Argb argb, const char **name)
{
	int i;
...
static Eina_Bool _egueb_svg_color_keyword_from(Egueb_Svg_Color *color, const char *attr_val)
{
	...
	if (!_egueb_svg_color_name_to_value(attr_val, &argb))
	{
		return EINA_FALSE;
	}
 ...
 *                             Value interface                                *
 *----------------------------------------------------------------------------*/
#define _egueb_svg_color_interpolate NULL
EGUEB_DOM_VALUE_PRIMITIVE_SIMPLE_BOLIERPLATE(egueb_svg_color, Egueb_Svg_Color);
/*============================================================================*
 *                                 Global                                     *
 *============================================================================*/
/*============================================================================*
...
EAPI char * egueb_svg_color_string_to(Egueb_Svg_Color *thiz)
{
	...
	if (_egueb_svg_color_value_to_name(argb, &name))
		return strdup(name);
	else
	{
		ERR("TODO");
