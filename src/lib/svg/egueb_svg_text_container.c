...
#include "egueb_svg_text_container.h"
...
#include "egueb_svg_text_container_private.h"
/*============================================================================*
 *                                  Local                                     *
 *============================================================================*/
static void _egueb_svg_text_container_children_generate_geometry(
		Egueb_Svg_Text_Container *thiz, Enesim_Renderer *r)
{
	Egueb_Svg_Element *e;
	Egueb_Svg_Text_Container_Pen *pen = &thiz->pen;
...
static Eina_Bool _egueb_svg_text_container_children_process_cb(Egueb_Dom_Node *child,
		void *data)
{
	Egueb_Svg_Text_Container *thiz = data;
	...
	if (type == EGUEB_DOM_NODE_TYPE_TEXT)
	{
		...
		_egueb_svg_text_container_children_generate_geometry(thiz, ren);
 ...
 */
static void _egueb_svg_text_container_node_inserted_cb(Egueb_Dom_Event *e,
		void *data)
{
	...
	if (type == EGUEB_DOM_NODE_TYPE_TEXT)
	{
		Egueb_Svg_Text_Container *thiz;
		Egueb_Dom_String *private_data;
		Enesim_Text_Buffer *nb = NULL;
		Enesim_Renderer *r;

		thiz = EGUEB_SVG_TEXT_CONTAINER(n);
...
static void _egueb_svg_text_container_node_removed_cb(Egueb_Dom_Event *e,
		void *data)
{
	Egueb_Dom_Node *n = data;
	Egueb_Dom_Node *related = NULL;
 ...
 *----------------------------------------------------------------------------*/
static Enesim_Renderer * _egueb_svg_text_container_renderer_get(
		Egueb_Svg_Renderable *r)
{
	Egueb_Svg_Text_Container *thiz;

	thiz = EGUEB_SVG_TEXT_CONTAINER(r);
	return enesim_renderer_ref(thiz->r);
}

static void _egueb_svg_text_container_bounds_get(Egueb_Svg_Renderable *r,
		Enesim_Rectangle *bounds)
{
	/* TODO
...
static void _egueb_svg_text_container_painter_apply(Egueb_Svg_Renderable *r,
		Egueb_Svg_Painter *painter)
{
	...
	egueb_dom_node_children_foreach(n,
		_egueb_svg_text_container_children_process_cb,
		thiz);
	thiz->renderable_tree_changed = EINA_FALSE;
}

static Eina_Bool _egueb_svg_text_container_process(Egueb_Svg_Renderable *r)
{
	Egueb_Svg_Text_Container *thiz;
	Egueb_Svg_Element *e;
	Egueb_Svg_Length *c;
 ...
 *                              Element interface                             *
 *----------------------------------------------------------------------------*/
static Egueb_Dom_String * _egueb_svg_text_container_tag_name_get(
		Egueb_Dom_Element *e)
{
...
ENESIM_OBJECT_INSTANCE_BOILERPLATE(EGUEB_SVG_TEXT_CONTENT_DESCRIPTOR,
		Egueb_Svg_Text_Container, Egueb_Svg_Text_Container_Class,
		egueb_svg_text_container);

static void _egueb_svg_text_container_class_init(void *k)
{
	Egueb_Svg_Renderable_Class *r_klass;
	Egueb_Dom_Element_Class *e_klass;

	r_klass = EGUEB_SVG_RENDERABLE_CLASS(k);
	r_klass->bounds_get = _egueb_svg_text_container_bounds_get;
	r_klass->renderer_get = _egueb_svg_text_container_renderer_get;
	r_klass->process = _egueb_svg_text_container_process;
	r_klass->painter_apply = _egueb_svg_text_container_painter_apply;

	e_klass= EGUEB_DOM_ELEMENT_CLASS(k);
	e_klass->tag_name_get = _egueb_svg_text_container_tag_name_get;
}

static void _egueb_svg_text_container_instance_init(void *o)
{
	Egueb_Svg_Text_Container *thiz;
	...
	thiz = EGUEB_SVG_TEXT_CONTAINER(o);
	...
	*zero = EGUEB_SVG_LENGTH_0;
	...
	egueb_dom_event_target_event_listener_add(evt,
			...
			_egueb_svg_text_container_node_inserted_cb,
			EINA_TRUE, thiz);
	egueb_dom_event_target_event_listener_add(evt,
			EGUEB_DOM_EVENT_MUTATION_NODE_REMOVED,
			_egueb_svg_text_container_node_removed_cb,
			EINA_TRUE, thiz);
}

static void _egueb_svg_text_container_instance_deinit(void *o)
{
	Egueb_Svg_Text_Container *thiz;
