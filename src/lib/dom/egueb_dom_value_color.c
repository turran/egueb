...
static void _egueb_dom_value_color_data_from(Egueb_Dom_Value *v, Egueb_Dom_Value_Data *data)
{
	EINA_SAFETY_ON_FALSE_RETURN(v->descriptor == &_descriptor);
	egueb_dom_value_i32_data_from(v, data);
}

static void _egueb_dom_value_color_data_to(Egueb_Dom_Value *v, Egueb_Dom_Value_Data *data)
{
	EINA_SAFETY_ON_FALSE_RETURN(v->descriptor == &_descriptor);
...
static Egueb_Dom_Value_Descriptor _descriptor = {
	/* .data_from 		= */ _egueb_dom_value_color_data_from,
	/* .data_from_type 	= */ EGUEB_DOM_VALUE_DATA_TYPE_INT32,
	/* .data_to 		= */ _egueb_dom_value_color_data_to,
	/* .data_to_type 	= */ EGUEB_DOM_VALUE_DATA_TYPE_PTR,
	/* .init 		= */ NULL,
	/* .free 		= */ NULL,
	/* .copy 		= */ NULL,
	/* .string_to 		= */ _egueb_dom_value_color_string_to,
	/* .string_from 	= */ _egueb_dom_value_color_string_from,
	/* .interpolate 	= */ _egueb_dom_value_color_interpolate,
};
/*============================================================================*
 *                                 Global                                     *
 *============================================================================*/
...
EAPI const Egueb_Dom_Value_Descriptor *
		egueb_dom_value_color_descriptor_get(void)
{
	return &_descriptor;
}
