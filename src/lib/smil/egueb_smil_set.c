 ...
 *----------------------------------------------------------------------------*/
#if 0
static Eina_Bool _egueb_smil_set_setup(Egueb_Dom_Tag *t,
		...
		Enesim_Log **error)
{
	...
	Egueb_Smil_Duration *dur = &actx->timing.dur;
	Ender_Element *svg_e;
	Ender_Container *ec;
	...
	thiz = _egueb_smil_set_get(t);
	_egueb_smil_set_cleanup(thiz);
	...
	if (!strcmp(name, "egueb_smil_animated_transform"))
		return EINA_FALSE;
	else if (!strcmp(name, "egueb_smil_animated_frequency"))
		return EINA_FALSE;
...
static Egueb_Smil_Animation_Descriptor _descriptor = {
	/* .attribute_get 	= */ _egueb_smil_set_attribute_get,
	/* .free 		= */ _egueb_smil_set_free,
	/* .initialize 		= */ _egueb_smil_set_initialize,
	/* .attribute_set 	= */ _egueb_smil_set_attribute_set,
	/* .setup 		= */ _egueb_smil_set_setup,
	/* .enable 		= */ _egueb_smil_set_enable,
	/* .disable 		= */ _egueb_smil_set_disable,
};
#endif
/*----------------------------------------------------------------------------*
 *                             Animation interface                            *
