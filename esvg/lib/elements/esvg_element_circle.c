 ...
 *                                  Local                                     *
 *============================================================================*/
#define ESVG_LOG_DEFAULT _esvg_element_circle_log

static int _esvg_element_circle_log = -1;

static Ender_Property *ESVG_ELEMENT_CIRCLE_CX;
static Ender_Property *ESVG_ELEMENT_CIRCLE_CY;
static Ender_Property *ESVG_ELEMENT_CIRCLE_R;

typedef struct _Esvg_Element_Circle
{
	/* properties */
...
static Esvg_Element_Circle * _esvg_element_circle_get(Edom_Tag *t)
{
 ...
 *----------------------------------------------------------------------------*/
static Eina_Bool _esvg_element_circle_attribute_set(Ender_Element *e,
		const char *key, const char *value)
{
	if (strcmp(key, "cx") == 0)
	{
		...
		esvg_element_circle_cx_set(e, &cx);
	}
	else if (strcmp(key, "cy") == 0)
	{
		...
		esvg_element_circle_cy_set(e, &cy);
	}
	else if (strcmp(key, "r") == 0)
	{
		...
		esvg_element_circle_r_set(e, &radius);
	}
	else
	{
		return EINA_FALSE;
...
static Eina_Bool _esvg_element_circle_attribute_get(Edom_Tag *tag, const char *attribute, char **value)
{
	return EINA_FALSE;
}

static int * _esvg_element_circle_attribute_animated_fetch(Edom_Tag *t, const char *attr)
{
	Esvg_Element_Circle *thiz;
	int *animated = NULL;

	thiz = _esvg_element_circle_get(t);
	if (!strcmp(attr, "cx"))
	{
...
static Enesim_Renderer * _esvg_element_circle_renderer_get(Edom_Tag *t)
{
	Esvg_Element_Circle *thiz;
...
static Esvg_Element_Setup_Return _esvg_element_circle_setup(Edom_Tag *t,
		Esvg_Context *c,
...
static Eina_Bool _esvg_element_circle_renderer_propagate(Edom_Tag *t,
		Esvg_Context *c,
...
static void _esvg_element_circle_free(Edom_Tag *t)
{
	Esvg_Element_Circle *thiz;
...
#if 0
static Eina_Bool _esvg_element_circle_has_changed(Enesim_Renderer *r)
{
	Esvg_Element_Circle *thiz;

	thiz = _esvg_element_circle_get(r);
...
static Esvg_Renderable_Descriptor _descriptor = {
	/* .child_add			= */ NULL,
	/* .child_remove		= */ NULL,
	/* .attribute_get 		= */ _esvg_element_circle_attribute_get,
	/* .cdata_set 			= */ NULL,
	/* .text_set 			= */ NULL,
	/* .text_get		     	= */ NULL,
	/* .free 			= */ _esvg_element_circle_free,
	/* .initialize 			= */ NULL,
	/* .attribute_set 		= */ _esvg_element_circle_attribute_set,
	/* .attribute_animated_fetch 	= */ _esvg_element_circle_attribute_animated_fetch,
	/* .setup			= */ _esvg_element_circle_setup,
	/* .renderer_get		= */ _esvg_element_circle_renderer_get,
	/* .renderer_propagate		= */ _esvg_element_circle_renderer_propagate,
};
/*----------------------------------------------------------------------------*
 *                           The Ender interface                              *
 *----------------------------------------------------------------------------*/
static Edom_Tag * _esvg_element_circle_new(void)
{
	Esvg_Element_Circle *thiz;
	Edom_Tag *t;
	Enesim_Renderer *r;

	thiz = calloc(1, sizeof(Esvg_Element_Circle));
	if (!thiz) return NULL;
...
static void _esvg_element_circle_cx_set(Edom_Tag *t, const Esvg_Animated_Coord *cx)
{
	Esvg_Element_Circle *thiz;
...
static void _esvg_element_circle_cx_get(Edom_Tag *t, Esvg_Animated_Coord *cx)
{
	Esvg_Element_Circle *thiz;
...
static void _esvg_element_circle_cy_set(Edom_Tag *t, const Esvg_Animated_Coord *cy)
{
	Esvg_Element_Circle *thiz;
	Esvg_Length def = { ESVG_UNIT_LENGTH_PX, 0 };
	Eina_Bool animating;
...
static void _esvg_element_circle_cy_get(Edom_Tag *t, Esvg_Animated_Coord *cy)
{
	Esvg_Element_Circle *thiz;
...
static void _esvg_element_circle_r_set(Edom_Tag *t, const Esvg_Length_Animated *radius)
{
	Esvg_Element_Circle *thiz;
	Esvg_Length def = { ESVG_UNIT_LENGTH_PX, 0 };
	Eina_Bool animating;
...
static void _esvg_element_circle_r_get(Edom_Tag *t, Esvg_Length_Animated *radius)
{
	Esvg_Element_Circle *thiz;
...
/* The ender wrapper */
#define _esvg_element_circle_delete NULL
...
void esvg_element_circle_init(void)
{
	_esvg_element_circle_log = eina_log_domain_register("esvg_element_circle", ESVG_LOG_COLOR_DEFAULT);
	if (_esvg_element_circle_log < 0)
	{
		EINA_LOG_ERR("Can not create log domain.");
		return;
	}
	_esvg_element_circle_init();
}

void esvg_element_circle_shutdown(void)
{
	if (_esvg_element_circle_log < 0)
		return;
	_esvg_element_circle_shutdown();
	eina_log_domain_unregister(_esvg_element_circle_log);
	_esvg_element_circle_log = -1;
}
/*============================================================================*
 *                                   API                                      *
 *============================================================================*/
...
{
	esvg_element_property_length_set(e, ESVG_ELEMENT_CIRCLE_CX, cx);
}

EAPI void esvg_element_circle_cx_get(Ender_Element *e, Esvg_Coord *cx)
{
}

EAPI void esvg_element_circle_cy_set(Ender_Element *e, const Esvg_Coord *cy)
{
	esvg_element_property_length_set(e, ESVG_ELEMENT_CIRCLE_CY, cy);
}

EAPI void esvg_element_circle_cy_get(Ender_Element *e, Esvg_Coord *cy)
{
}

EAPI void esvg_element_circle_r_set(Ender_Element *e, const Esvg_Length *r)
{
	esvg_element_property_length_set(e, ESVG_ELEMENT_CIRCLE_R, r);
}

EAPI void esvg_element_circle_r_get(Ender_Element *e, Esvg_Length *r)
{
}
