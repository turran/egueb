 ...
 *                                  Local                                     *
 *============================================================================*/
#define ESVG_LOG_DEFAULT _esvg_element_text_log

static int _esvg_element_text_log = -1;

static Ender_Property *ESVG_ELEMENT_TEXT_X;
static Ender_Property *ESVG_ELEMENT_TEXT_Y;

typedef struct _Esvg_Element_Text
{
	/* properties */
...
static Esvg_Element_Text * _esvg_element_text_get(Edom_Tag *t)
{
 ...
 *----------------------------------------------------------------------------*/
static Eina_Bool _esvg_element_text_attribute_set(Ender_Element *e,
		const char *key, const char *value)
{
	...
	else if (strcmp(key, "font-size") == 0)
	{
		...
		esvg_element_text_font_size_set(r, &font_size);
	}
#endif
	else
	{
...
static Eina_Bool _esvg_element_text_attribute_get(Edom_Tag *tag,
...
static void _esvg_element_text_text_set(Edom_Tag *t, const char *text, unsigned int length)
{
	Esvg_Element_Text *thiz;
	char *modified;
	char past;
...
static void _esvg_element_text_text_get(Edom_Tag *t, const char **text, unsigned int *length)
{
	Esvg_Element_Text *thiz;
...
static Enesim_Renderer * _esvg_element_text_renderer_get(Edom_Tag *t)
{
	Esvg_Element_Text *thiz;
...
static Esvg_Element_Setup_Return _esvg_element_text_setup(Edom_Tag *t,
		Esvg_Context *c,
...
static Eina_Bool _esvg_element_text_renderer_propagate(Edom_Tag *t,
		Esvg_Context *c,
...
#if 0
static Eina_Bool _esvg_element_text_has_changed(Edom_Tag *t)
{
	Esvg_Element_Text *thiz;

	thiz = _esvg_element_text_get(r);
...
static void _esvg_element_text_free(Edom_Tag *t)
{
	Esvg_Element_Text *thiz;
...
static Esvg_Renderable_Descriptor _descriptor = {
	/* .child_add		= */ NULL,
	/* .child_remove	= */ NULL,
	/* .attribute_get	= */ _esvg_element_text_attribute_get,
	/* .cdata_set		= */ NULL,
	/* .text_set		= */ _esvg_element_text_text_set,
	/* .text_get		     = */ _esvg_element_text_text_get,
	/* .free		= */ _esvg_element_text_free,
	/* .initialize		= */ NULL,
	/* .attribute_set	= */ _esvg_element_text_attribute_set,
	/* .attribute_animated_fetch = */ NULL,
	/* .setup		= */ _esvg_element_text_setup,
	/* .renderer_get	= */ _esvg_element_text_renderer_get,
	/* .renderer_propagate	= */ _esvg_element_text_renderer_propagate,
};
/*----------------------------------------------------------------------------*
 *                           The Ender interface                              *
 *----------------------------------------------------------------------------*/
static Edom_Tag * _esvg_element_text_new(void)
{
	Esvg_Element_Text *thiz;
	Edom_Tag *t;
	Enesim_Renderer *r;
...
static void _esvg_element_text_x_set(Edom_Tag *t, const Esvg_Animated_Coord *x)
{
	Esvg_Element_Text *thiz;
...
static void _esvg_element_text_x_get(Edom_Tag *t, Esvg_Animated_Coord *x)
{
	Esvg_Element_Text *thiz;
...
static void _esvg_element_text_y_set(Edom_Tag *t, const Esvg_Animated_Coord *y)
{
	Esvg_Element_Text *thiz;
	Esvg_Coord def = { ESVG_UNIT_LENGTH_PX, 0 };
	Eina_Bool animating;
...
static void _esvg_element_text_y_get(Edom_Tag *t, Esvg_Animated_Coord *y)
{
	Esvg_Element_Text *thiz;
 ...
 *                                 Global                                     *
 *============================================================================*/
void esvg_element_text_init(void)
{
	_esvg_element_text_log = eina_log_domain_register("esvg_element_text", ESVG_LOG_COLOR_DEFAULT);
	if (_esvg_element_text_log < 0)
	{
		EINA_LOG_ERR("Can not create log domain.");
		return;
	}
	_esvg_element_text_init();
}

void esvg_element_text_shutdown(void)
{
	if (_esvg_element_text_log < 0)
		return;
	_esvg_element_text_shutdown();
	eina_log_domain_unregister(_esvg_element_text_log);
	_esvg_element_text_log = -1;
}
/*============================================================================*
 *                                   API                                      *
 *============================================================================*/
...
{
	esvg_element_property_length_set(e, ESVG_ELEMENT_TEXT_X, x);
}
...
{
	esvg_element_property_length_set(e, ESVG_ELEMENT_TEXT_Y, y);
}
