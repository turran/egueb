 ...
 *                                  Local                                     *
 *============================================================================*/
static Eina_Bool _esvg_attribute_visibility_value_get(const char *attr, void **value)
{
	Esvg_Visibility *v = *value;

	esvg_visibility_string_from(v, attr);
	return EINA_TRUE;
}

/* The different animated desriptors */
Esvg_Attribute_Animated_Descriptor esvg_attribute_animated_visibility_descriptor = {
	/* .value_new 			= */ esvg_attribute_enum_value_new,
	/* .value_get 			= */ _esvg_attribute_visibility_value_get,
	/* .value_free 			= */ free,
